                ...
                {skippedTokens.length > 0 && (
                  <div>
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <Badge variant="secondary" className="bg-yellow-500/15 text-yellow-400 border border-yellow-500/30 text-xs" data-testid="badge-skipped-count">
                      ...
                      {skippedTokens.map((token) => {
                        ...
                        return (
                          <div
                            ...
                            data-testid={`row-skipped-${token.symbol}`}
                          >
                            <div className="flex items-center gap-2">
